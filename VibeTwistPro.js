        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl bg-white/10 p-6 space-y-4 backdrop-blur">
            ...
            <motion.div
              ...
              className="aspect-square rounded-3xl bg-black/40 flex items-center justify-center text-8xl overflow-hidden"
            >
              {img ? (
...
>>>>>>> f493c0d (Stabilise VibeTwistPro component for Vercel)
